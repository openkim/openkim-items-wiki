...
Additionally, the form of $$g(\theta)$$ used in this model driver is modified by the factor $$\gamma_{ijk}$$ to take the form below ([as documented in LAMMPS](http://lammps.sandia.gov/doc/pair_tersoff.html)):
